...
final class DevicePropertiesAddViewController: NSViewController, CategoryRepresenting {
    let category: Configuration.Category = .deviceProperties
    ...
    override var representedObject: Any? {
        didSet {
            ...
            deviceProperties = configuration.deviceProperties
        }
    }
...
//        deviceProperties?.additions?.insert(.init(), at: index)
...
//            deviceProperties?.additions?.remove(at: $0)
...
//        return Array(deviceProperties?.additions?.keys)[row]
        return nil
    }
}

extension DevicePropertiesAddViewController: NSTableViewDelegate {
...
//            }
//
//            cell.provideValue = { ($0 as? DeviceProperties.Addition)?.comment }
//            cell.handleValueChange = { ($0 as? DeviceProperties.Addition)?.comment = $1 }
//
...
//            }
//
//            cell.provideValue = { ($0 as? DeviceProperties.Addition)?.isEnabled }
//            cell.handleValueChange = { ($0 as? DeviceProperties.Addition)?.isEnabled = $1 }
//
...
//            }
//
//            cell.provideValue = { ($0 as? DeviceProperties.Addition)?.path }
//            cell.handleValueChange = { ($0 as? DeviceProperties.Addition)?.path = $1 }
//
//        default:
//            break
//        }
